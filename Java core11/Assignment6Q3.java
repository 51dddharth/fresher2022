public class Assignment6Q3 {
    public static void main(String[] args) {
       ...
       /* Employe obj = new Employe(100, "Dwight", "sales", 88000);
        Employe obj1 = new Employe(101, "suraj", "sales", 80000);
        Employe obj2 = new Employe(102, "piyush", "sales", 40000);
        Employe obj3 = new Employe(103, "shivam", "sales", 90000);
        Employe obj4 = new Employe(104, "shubham", "accounts", 98000);
        Employe obj5 = new Employe(105, "sanyam", "accounts", 99000);
        Employe obj6 = new Employe(106, "prateek", "HR", 97000);
