...
public class Assignment6Q4 {
    ...
    public static void main (String[]args){
        ...
        dob.add(new Assignment6Q4(07, 12, 2000));
        dob.add(new Assignment6Q4(10, 10, 1999));
        dob.add(new Assignment6Q4(23, 12, 2000));
        dob.add(new Assignment6Q4(06, 07, 2008));
        dob.add(new Assignment6Q4(28, 11, 1999));
        dob.add(new Assignment6Q4(19, 05, 2012));
        dob.add(new Assignment6Q4(21, 01, 1992));
